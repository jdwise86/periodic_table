...
--
-- Name: properties fk_customer; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.properties
    ADD CONSTRAINT fk_customer FOREIGN KEY (atomic_number) REFERENCES public.elements(atomic_number);
